...
ENV DJANGO_SETTINGS_MODULE=cybersecurity.settings.production DJANGO_DEBUG=off

# Tell uWSGI where to find your wsgi file:
ENV UWSGI_WSGI_FILE=cybersecurity/wsgi.py
...
VOLUME ["/code/cybersecurity/media/images/"]
