# Generated by Django 4.0.8 on 2023-01-04 13:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', modelcluster.fields.ParentalManyToManyField(blank=True, to='science.scienceingredient')),
                ('origin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='science.country')),
                ('science_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='science.sciencetype')),
            ],
            options={
                'abstract': False,
            },
